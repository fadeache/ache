...
const state = reactive({
  ...
  wallpapers: [
    ...
    },
    {
      title: "3.书接上文",
      content:
        "博客可根据不同分类显示对应博文摘要，支持模糊搜索并高亮，点击可跳转至CSDN查看详情。动画采用纯css编写，句子的接口为开源接口转发而来。图标采用后端接口调用图标，数据库存储图标，前端图标组件化复用等方式，统一管理，操作便捷，极大提升了开发与维护效率，节约时间成本的同时减少了代码量，为图标的使用提供了新的解题思路。网站图标均从数据库调用，可在图标中心一键修改名称、编码、颜色、样式等属性。关于页显示所有访客浏览记录，并根据时间段和设备类型作出图表统计。",
      pic: "/main/fours.jpg",
    },
  ],
});
